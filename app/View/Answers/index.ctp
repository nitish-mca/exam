<div class="answers index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($answer['Question']['description'], array('controller' => 'questions', 'action' => 'view', $answer['Question']['id'])); ?>
		</td>
		<td><?php echo h($answer['Answer']['name']); ?>&nbsp;</td>
		<td><?php echo h($answer['Answer']['description']); ?>&nbsp;</td>
		<td><?php echo h($answer['Answer']['image_path']); ?>&nbsp;</td>
