    ...
    <ul class="nav nav-list">
        ...
        <li class="">
            ...
            <ul class="submenu">
                ...
                <li class="">
                    <a href="<?php echo $this->Html->url(array('controller' => 'tasks', 'action' => 'add')); ?>">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Add Task
                    </a>
        ...
        <li class="">
            ...
            <ul class="submenu">
                <li class="">
                    <a href="<?php echo $this->Html->url(array('controller' => 'projects', 'action' => 'index')); ?>">
                        <i class="menu-icon fa fa-caret-right"></i>
                        List Projects
                    </a>
                ...
                <li class="">
                    <a href="<?php echo $this->Html->url(array('controller' => 'projects', 'action' => 'add')); ?>">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Add Project
                    </a>
        ...
        <li class="">
            ...
            <ul class="submenu">
                <li class="">
                    <a href="<?php echo $this->Html->url(array('controller' => 'departments', 'action' => 'index')); ?>">
                        <i class="menu-icon fa fa-caret-right"></i>
                        List Department
                    </a>
                ...
                <li class="">
                    <a href="<?php echo $this->Html->url(array('controller' => 'departments', 'action' => 'add')); ?>">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Add Department
                    </a>
